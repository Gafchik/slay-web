export default {
  ...
  pricing: {
    ...
    subTitle: 'Выберите свой тарифный план и получите полный доступ ко всем функциям SLAY',
    info: {
      free: 'после 1 месяца бесплатно',
      list: [
        {
          key: 'full',
        ...
        {
          key: 'period',
          title: 'Доступ до конца расчетного периода'
        },
        {
          key: 'renewal',
        ...
        {
          key: 'discount',
          title: 'Экономия {discount} по сравнению с помесячной оплатой'
        },
      ],
      taxes: 'Налоги могут применяться при оформлении заказа в зависимости от вашего местоположения.',
      autoPay: '{price} будет списано {period} после окончания пробного периода',
    },
    features: {
      title: 'Все включено',
    ...
    details: [
      {
        ...
        description: 'Пробная версия начинаеться с момента регистрации',
      },
      {
        icon: 'cached',
        title: 'После окончания пробного периода доступ к сервису потребует оплаты',
        description: 'После оплаты доступ будет возобновлен без потери данных.',
      },
      {
      ...
      {
        icon: 'safety_check',
        title: 'Безопасные платежи, обрабатываемые Paddle.',
        description: 'Ваша платежная информация в безопасности и никогда не хранится у нас.',
      },
      {
        icon: 'lock',
        title: 'Мы используем сквозное шифрование.',
    ...
    cards: {
      ...
      sixMonths: {
        title: "6 месяцев",
        subtitle: "Оплата каждые 6 месяцев",
        price: "$6.99",
        discount: "12%",
        discountPrice: "$6",
        badge: ""
