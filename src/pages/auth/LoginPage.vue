              ...
              <div class="flex">
                ...
                <div class="col q-px-xl">
                  <q-form @submit="onSubmit" ref="form">
                    <button class="gsi-material-button q-mb-lg" @click="loginGoggleRequest">
                    ...
                    <div class="flex justify-center q-mb-md q-py-xs">
                    ...
                    <div class="column items-center">
                      ...
                      <q-btn
                        ...
                        rounded
                        no-caps
                        class="btn-link--blue q-px-sm q-mb-md"
...
<style scoped lang="scss">
  ...
  .gsi-material-button {
    ...
    box-shadow: 0 4px 4px 0 rgba(0, 0, 0, 0.25), 2px 4px 4px 0 #0C2C62 inset;
